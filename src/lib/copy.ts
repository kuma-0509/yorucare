...
export const COPY = {
  ...
  /**
   * 気持ちのラベルとの役割の違いを、見出しの直後に書く。
   * 感じている気持ちは「気持ち」で選び、ここは体と生活に出た変化だけを選ぶ。
   */
  warningSignDescription:
    "体や生活に、いつもと違うところがあれば選んでください。感じている気持ちは「くわしく書く」の中の「気持ち」で選べます。気になることがなければ、選ばなくても構いません。",
  memo: "メモ",
  memoOptional: "メモ（任意）",
