...
export const COPY = {
  ...
  completion: {
    ...
    // 全体のヒント。どれも記録の扱いは同じで、変わるのは見せ方だけだと先に伝える
    hint: "どれを選んでも、記録は消えません。変わるのは、気持ちの区切り方（画面の見せ方）だけです。",
    shelf: "書庫にしまう",
    shelfDesc: "今日の記録を大切に保管する",
    // 比喩だけでは何が起きるか分からないため、各選択肢の直下にも同じ事実を置く
    shelfNote: "記録はこれまでどおり残ります。本の形にして棚へ収める見せ方です。",
    paper: "紙にして手放す",
    paperDesc: "今日のモヤモヤを外に出して区切る",
    paperNote: "記録はこれまでどおり残ります。紙を手放す見せ方で、気持ちだけ区切ります。",
    skip: "今日はそのまま",
    skipDesc: "演出なしで終える",
    skipAction: "このまま終える",
