...
export const COPY = {
  ...
  /**
   * 「できること」（登録簿）と「できたこと」（その日の実施記録）は、同じセルフケアの
   * 別の側面である。語は分けたまま（登録簿と実施記録を取り違えると、登録しただけの項目が
   * 実施として数えられる）、両者のつながりだけを画面の案内文で示す。
   * 登録簿を出す画面と実施を選ぶ画面の両方に置き、どちらから来ても関係が分かるようにする。
   */
  selfCareRelation: {
    /** 「できること」タブの見出し下。登録簿そのものの説明 */
    registryDescription: "自分に合う「できること」を登録しておく場所です。",
    /** 「できること」タブの見出し下。登録簿 → 実施記録のつながり */
    registryToRecord:
      "登録したものは「書く」タブに並びます。その日にできたものを選ぶと、「できたこと」としてその日の記録に残ります。",
    /** 記録画面の「今日できたこと」欄。実施記録 → 登録簿のつながり */
    recordFromRegistryToday:
      "ここに並ぶのは「できること」タブに登録したものです。今日できたものを選ぶと「今日できたこと」として残ります。",
    /** 記録画面の「できたこと」欄（今日以外の日） */
    recordFromRegistryOther:
      "ここに並ぶのは「できること」タブに登録したものです。その日にできたものを選ぶと「できたこと」として残ります。",
  },
