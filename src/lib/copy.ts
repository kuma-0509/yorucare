...
export const COPY = {
  ...
  /**
   * クラウド保存のログイン確認。コード送信の失敗理由だけを分ける。
   * 案内にメールアドレスや問い合わせ先は出さない。
   */
  cloudLogin: {
    sendFailed: "コードを送れませんでした。時間をおいてもう一度お試しください。",
    sendNotAllowed:
      "このメールアドレスではコードを送れません。入力内容を確認してください。",
    // ログイン済みのまま、6桁コードだけやり直す。ログアウトはしない
    reauthHeading: "本人確認をもう一度します",
    reauthBody:
      "ログインは続いています。この端末の記録は消えません。同じメールアドレスに6桁のコードを送り、本人確認だけをやり直します。",
    reauthStartAction: "本人確認をやり直す",
    reauthVerifyAction: "本人確認する",
    reauthDone:
      "本人確認ができました。設定画面に戻って、消す操作をやり直してください。",
    reauthBackAction: "設定に戻る",
    reauthCancelAction: "やめる",
  },
  /**
  ...
  cloudBackup: {
    ...
    details: [
      ...
      {
        heading: "預かる期間",
        body: "あなたが消すまで預かります。使っていないからといって自動で消すことはしません。この機能の提供を終えるときは、1か月前までにこの画面でお知らせします。",
      },
      {
        heading: "消し方",
    ...
    // 戻しただけでは、この端末から預け直しは始まらない（預けることへの同意は
    // 別の操作）。「預ける端末にしました」だけで終えると、守られていない
    // つもりのまま使い続けてしまう
    restoreDone:
      "戻しました。この端末で続けて預けるには、下の「この内容を預ける」を押してください。",
    restoreDoneClaimFailed:
      "戻しました。ただし、この端末を預ける端末として登録できませんでした。時間をおいて、もう一度「クラウドから戻す」からやり直してください。",
    restoreFailed:
    ...
    leaveSignOutFailed:
      "クラウド上の控えは消しましたが、ログアウトできませんでした。時間をおいてもう一度お試しください。この端末の記録はそのまま残っています。",
    // 再認証。取り返しのつかない操作の前に必ず通す。ログアウトはしない
    reauthRequired:
      "本人確認から時間が経っています。安全のため、もう一度本人確認してから消します。",
    reauthAction: "もう一度本人確認する",
    busy: "処理しています…",
  },
